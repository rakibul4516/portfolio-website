...
export default function Contact() {
    return (
        <section className="min-h-screen bg-cover w-10/12 mx-auto" style={{backgroundImage: `url('https://images.ud=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1470&q=80')`}}>
